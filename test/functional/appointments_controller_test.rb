...
class AppointmentsControllerTest < ActionController::TestCase
  ...
  test "should update appointment" do
    put :update, id: @appointment, appointment: { comments: @appointment.comments, end_time: @appointment.end_time, first_name: @appointment.first_name, last_name: @appointment.last_name, start_time: @appointment.start_time }
    assert_redirected_to appointment_path(assigns(:appointment))
  end
